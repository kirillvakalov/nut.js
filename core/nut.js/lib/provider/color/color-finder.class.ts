import { ColorFinderInterface } from "@kirillvakalov/nut-tree__provider-interfaces";
import { ColorQuery, imageToJimp, MatchRequest, MatchResult, Point } from "@kirillvakalov/nut-tree__shared";
